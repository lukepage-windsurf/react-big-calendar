...
var Formats = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _constants.views.MONTH, 'monthHeaderFormat'), _constants.views.WEEK, 'dayRangeHeaderFormat'), _constants.views.DAY, 'dayHeaderFormat'), _constants.views.AGENDA, 'agendaHeaderFormat'), _constants.views.MULTI, 'dayHeaderFormat');
